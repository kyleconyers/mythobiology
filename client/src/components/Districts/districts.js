      ...
      <Container className="districtContainer">
        <Row>
          <p id="state_selector_text">
             Select a state: <SelectUSState value="Washington" id="state_selector" className="myClassName browser-default" onChange={this.props.changeUSState} />
          </p>
        </Row>        
        <Row>
          {(usStateToUse == null)?(
                ...
                <List>
                  ...
                  waSenators.map(senator => (
                    <Senator
                      ...
                      twitter_handle={senator.twitter_handle}
                    />
